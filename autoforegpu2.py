...
class AutoFore:
	...
	def execute(self):
		...
		self.instrucciones=[]
		self.execute2(instrucciones,cpu=cpu)
	...
	def addInstruction(self,op,dest,src1,src2):
...
class Variable:
	...
	def __add__(self, other):
		...
		self.nn.addInstruction(0,v.id2,self.id2,other.id2)
		return v
	...
	def __mul__(self, other):
		...
		self.nn.addInstruction(1,v.id2,self.id2,other.id2)
		return v
	...
	def __sub__(self, other):
		...
		self.nn.addInstruction(2,v.id2,self.id2,other.id2)
		return v
