...
class Parameters:
	def __init__(self,graphic=True,population=10,segments=5,seed=0,stereo=False):
		self.width = 600
		self.height = 600
		...
		self.stereo=stereo # True to use stereo vision, faster convergence
...
if __name__ == '__main__':
	...
	RoboticArm(Parameters(graphic=True, population=10, segments=4, seed=123,stereo=True))
